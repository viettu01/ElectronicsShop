                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <button id="btnDelete" type="button" class="btn btn-dark btn-sm float-right"
                                            role="button" title="Xóa danh mục" onclick="warningBeforeDelete()">
                                        <i class="fa fa-trash"></i>
                                    </button>

                                    <a class="btn btn-dark btn-sm float-right" role="button" title="Thêm danh mục"
                                       href="<c:url value="/admin/category/edit" />" style="margin-right: 5px">
                                        ...
                                        <table id="bootstrap-data-table-export"
                                            ...
                                            <c:forEach items="${model.listResult}" var="model" varStatus="loop">
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <a href="<c:url value="/admin/category/edit?id=${model.id}"/>">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a href="<c:url value="/admin/category/detail?id=${model.id}"/>">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
