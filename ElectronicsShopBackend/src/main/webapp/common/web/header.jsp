...
<%@ page import="com.tuplv.util.SecurityUtils" %>
                ...
                <div class="user-menu">
                    <ul>
                        ...
                        <security:authorize access="isAnonymous()">
                            <li><a href="<c:url value='/dang-nhap' />"><i class="fa fa-sign-in"></i> Đăng nhập</a></li>
                            <li><a href="#"><i class="fa fa-user"></i> Đăng ký</a></li>
                        </security:authorize>
                        <security:authorize access="isAuthenticated()">
                            <li><a href="#">
                                <i class="fa fa-user"></i> Xin chào, <%= SecurityUtils.getPrincipal().getFullName() %>
                            </a></li>
                            <li><a href="<c:url value='/thoat' />">
                                <i class="fa fa-sign-out"></i></i> Thoát
                            </a></li>
                        </security:authorize>
                    </ul>
                </div>
...
<div class="site-branding-area">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="logo">
                    <h1><a href="./"><img src="<c:url value='/template/web/img/logo.png'/>"></a></h1>
                </div>
            </div>
